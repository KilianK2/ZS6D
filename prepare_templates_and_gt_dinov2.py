...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_file',
                        default="./zs6d_configs/template_gt_preparation_configs/cfg_template_gt_generation_ycbv_dinov2.json")
        ...
        for template_name in tqdm(os.listdir(config['path_templates_folder'])):
            ...
            if os.path.isdir(path_template_folder) and template_name != "models" and template_name != "models_proc":
                ...
                for i, file in enumerate(filtered_files):
                    ...
                    desc_dino = desc_dino.squeeze(0).squeeze(0).detach().cpu().numpy()
                    ...
                    np.save(tmp_dict['img_desc'], desc_dino)
